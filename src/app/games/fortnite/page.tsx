  ...
  return (
    <div className="min-h-screen px-10 py-10 text-black">
      ...
      <div className="flex gap-6 mt-6">
        <img src="/Fortnite.png" className="w-28 rounded-lg" />
        <div>
          <h1 className="text-2xl text-white font-bold">Fortnite</h1>
          <p className="text-white/70 mt-2 max-w-2xl">
            Fortnite is a colorful, fast-paced battle royale game where 100 players fight to be the last one standing. It features building mechanics, unique weapons, constant map updates, and team-based modes, along with creative and sandbox experiences.
          </p>
        </div>
      </div>
